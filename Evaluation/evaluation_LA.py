...
"""
This script was used to evaluate the different profiles using recall, coverage, and cosine similarity scores
"""
...
def word_based_measures(tokens_O, tokens_GEN, pos, transcript, timeframe_LP, timeframe_EVAL, split):
    ## Exact repetition
    Cosine_E = compute_cosine_similarity(tokens_O, tokens_GEN)
    ...
    Cosine_L = compute_cosine_similarity(tokens_O, tokens_GEN)
