...
def compute_recall_coverage(overall_language, generated, list_of_words = False, generated_questions = True, additional_info = False):
...
def compute_cosine_similarity(overall_language, generated, additional_info=False):
