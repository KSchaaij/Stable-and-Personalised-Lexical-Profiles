...
def get_sentence_length(sentences):
    """
    This function takes one argument and returns the avg sentence length 
...
for transcript in os.listdir(directory):
    ...
    dir = os.path.join("Data_holdout_ANOM", ID)      # Switch to holdout folder if necessary
    ...
    for timeframe in timeframes:
        ...
        # POS_terms, _, POS_common = frequency_term_POS(tokens, 20, target_pos=["NOUN", "PRON", "CONJ", "ADJ", "VERB", "ADV"]) # integer represents the nr of stored items
