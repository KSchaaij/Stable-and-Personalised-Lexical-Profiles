...
The docx files containing the spoken dialogue transcripts used for constructing lexical profiles are subject to access and usage restrictions imposed by the data providers and therefore cannot be shared publicly. 
